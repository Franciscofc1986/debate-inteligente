...
<html lang="pt-BR">
  ...
  <body>
    ...
    <!--<div class="fixed-action-btn horizontal">
        ...
        <ul>
        <li><a class="btn-floating red"><i class="material-icons">question_answer</i></a></li>
    ...
    <div class="row container">
      <section class="col s12">
        ...
        <div class="card-panel grey lighten-5 z-depth-1">
          <div class="row valign-wrapper">
            <div class="col s2">
              <img src="img/Deus-existe.jpg" alt="" class="circle responsive-img"> 
            </div>
            <div class="col s10">
          ...
          <div class="row right">
          <a class="btn-floating waves-effect waves-light red lighten-3"><i class="material-icons">announcement</i></a>
          </div>
        </div>
      </div>
